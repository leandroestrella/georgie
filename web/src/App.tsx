...
function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-svh flex-col">
      ...
      {/* Persistent corner links: the author's portfolio (bottom-left) and this
          project's source (bottom-right). Faint until hovered so they stay out of
      ...
      <a
        ...
        className="fixed bottom-3 left-3 z-40 opacity-60 transition-opacity hover:opacity-100"
      >
        <img
      ...
      <a
        ...
        title={t('nav.repo')}
        className="text-muted-foreground hover:text-foreground fixed right-3 bottom-3 z-40 opacity-70 transition hover:opacity-100"
      >
