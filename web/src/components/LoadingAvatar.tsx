...
/**
 * The shared "loading" visual: the mascot with a speech bubble above it (a
 * bordered box + a CSS two-triangle tail, which — unlike a rotated bordered
 * square — leaves a clean black rim at the tip) saying "loading…". Used
 * wherever a page or card is waiting on data instead of a plain skeleton.
 */
